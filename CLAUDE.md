...
│   │   │   ├── Bootstrapper.cs ← the scene's entry point
│   │   │   ├── Doors/          ← Door.cs
│   │   │   ├── Level/          ← BeamZone.cs, LevelGoal.cs, UfoDrift.cs
│   │   │   ├── Pets/           ← Pet.cs
│   │   │   ├── Player/         ← PlayerController.cs, PlayerInteractor.cs, PlayerHands.cs, PlayerAnimator.cs
